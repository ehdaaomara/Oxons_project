                ...
                <View style={{ backgroundColor: "#ffff", flex: 1 }}>
                    <ScrollView>
                        <View style={{ height: height * 0.07, width: width * 0.6, backgroundColor: "#2b468b", alignSelf: "center", marginTop: height * 0.04, borderRadius: 30 }}>
                            <Text style={{ color: "#ffff", textAlign: 'center', fontWeight: "bold", fontSize: 20, marginTop: height * 0.015 }}>Brain</Text>
                        </View>
                        ...
                        {/* <View style={{height:height*0.1,width:width*0.3,backgroundColor:"#ffff",alignSelf:"center"}}>
                            <ActivityIndicator/>
                        </View> */}
                        ...
                        {/* <View>
                            {this.state.photo_uri == '' ? (
                                ...
                                <View>
                                    ...
                                    <Image
                                        source={require("./images/IMG_20220505_204021.jpg")}
                                        style={{ height: height * 0.5, width: width * 0.85, alignSelf: 'center', borderRadius: 15 }}
                                    />

                                    <Image
                                        source={require("./images/IMG_20220505_204049.jpg")}
                                        style={{ height: height * 0.5, width: width * 0.85, alignSelf: 'center', borderRadius: 15, marginTop: height * 0.03 }}
                                    />

                                    <Image
                                        source={require("./images/IMG_20220505_204107.jpg")}
                                        style={{ height: height * 0.5, width: width * 0.85, alignSelf: 'center', borderRadius: 15, marginTop: height * 0.03 }}
                                    />

                                    <Image
                                        source={require("./images/IMG_20220505_204126.jpg")}
                                        style={{ height: height * 0.5, width: width * 0.85, alignSelf: 'center', borderRadius: 15, marginTop: height * 0.03,marginBottom:height*0.03  }}
                                    />
                                </View>
                            )}
