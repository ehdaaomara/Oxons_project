...
export default class FemalePage extends React.Component {
    ...
    sendData() {
        ...
        axios
        .post(
            'http://10.10.10.8/server/Register_Mother.php', data_send
        ).then((res) => {
            if (res.data == 'error') {
                ...
                <View style={{ backgroundColor: "#ffff", flex: 1 }}>
                    <ScrollView>
                        <View style={{ width: '100%', height: '100%' }}>
                            ...
                            <Text style={{ color: "#db219c", textAlign: "center", marginTop: height * 0.03 }}>------------------ <Text style={{ color: "#2b468b", textAlign: "center", fontSize: 20 }}>عدد أطفالك و أعمارهم</Text> ------------------- </Text>

                            <View style={{ flexDirection: "row" }}>
                                <TextInput
                                    style={{ width: width * 0.4, height: height * 0.05, color: "#2b468b", borderRadius: 20, borderWidth: 2, borderColor: "#2b468b", marginTop: 20, marginLeft: 25, padding: 10, textAlign: "right" }}
                                    placeholder={" يتراوح العمر بين :"}
                                    placeholderTextColor={"#9296d5"}
                                    onChangeText={(value) => {
