                ...
                <View style={{ backgroundColor: "#ffff", flex: 1 }}>
                    <ScrollView>
                        <View style={{ height: height * 0.07, width: width * 0.6, backgroundColor: "#2b468b", alignSelf: "center", marginTop: height * 0.04, borderRadius: 30 }}>
                            <Text style={{ color: "#ffff", textAlign: 'center', fontWeight: "bold", fontSize: 20, marginTop: height * 0.015 }}>Uterine</Text>
                        </View>
                            ...
                            <>
                                ...
                                {this.state.show == true ? (
                                    ...
                                    <View >
                                        ...
                                        <Image
                                            source={require("./images/IMG_20220505_182810.jpg")}
                                            style={{ height: height * 0.5, width: width * 0.85, alignSelf: 'center', borderRadius: 15 }}
                                        />

                                        <Image
                                            source={require("./images/IMG_20220505_182841.jpg")}
