...
export default class FemalePage extends React.Component {
    ...
    sendData() {
        ...
        axios
        .post(
            'http://10.10.10.8/server/Register_Sugar.php', data_send
        ).then((res) => {
            if (res.data == 'error') {
                ...
                <View style={{ backgroundColor: "#ffff", flex: 1 }}>
                    <ScrollView>
                        <View style={{ width: '100%', height: '100%' }}>
                            <Image
                                source={require("./images/12276-2.jpg")}
                                style={{ width: width * 0.6, height: height * 0.2, marginLeft: width * 0.2, marginTop: height * 0.03 }}
                            />

                            {/* <View></View> */}
                            <Text style={{ color: "#db219c", textAlign: "center", marginTop: height * 0.02 }}>------------------------------- <Text style={{ color: "#2b468b", textAlign: "center", fontSize: 20 }}>الاسم</Text> ------------------------------- </Text>
